export type getAppStatesResponse = {
    data: {
        globalEmoteSet: {
            id: "62cdd34e72a832540de95857";
            name: "Global Emotes";
            emotes: [
                {
