export declare const versionEntryStates: readonly ["LISTED", "PERSONAL", "NO_PERSONAL"];
export declare const hostFileFormats: readonly ["WEBP", "AVIV"];
export declare const userConnectionPlatforms: readonly ["TWITCH", "DISCORD"];
